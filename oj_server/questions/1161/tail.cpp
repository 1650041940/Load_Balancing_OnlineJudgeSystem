...
THis ratHer obnoXious line oF CHaraCters surPrisingly triggers no Commands)OJ_IN";
    const string expect = R"OJ_OUT(moo^elet duPP bigduPbigduP reverse middle midelete
THis ratHer obnoXious line oF CHaraCters surPrisingly triggers no Commands^)OJ_OUT";
